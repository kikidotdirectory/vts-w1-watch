...
the 'clock' visualizes time with a pair of eyes. the opening of the eyes represents the minute with fully open representing :00 and nearly closed representing :59. the hour is represented by the direction the eyes are looking. it's not exactly useful for exact time-keeping but it should get you to the nearest quarter-hour. the design is based on the concept of someone dozing off watching the time pass. 
